...
void ThrusterPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
    ...
    this->conversionFunction.reset(
            ConversionFunctionFactory::GetInstance().CreateConversionFunction(_sdf->GetElement("conversion")));
...
/////////////////////////////////////////////////
void ThrusterPlugin::Reset() { this->thrusterDynamics->Reset(); }
...
/////////////////////////////////////////////////
void ThrusterPlugin::UpdateInput(ConstDoublePtr &_msg) { this->inputCommand = _msg->value(); }
}  // namespace gazebo
